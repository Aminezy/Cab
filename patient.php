...
// sql 
$con->query("update patient SET  nom='$nom ',adresse= '$adresse ', tel='$tel' WHERE id= '$id' " ) or die('erreur update patient');
}
//supression
if(isset($_POST['supp']))
{
...
$query = ("DELETE  FROM patient  WHERE id= '$id' ") or die('erreur delete');
$con->query($query);
...
<div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <div class="modal fade" id="supmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <h1> est ce que vous voullez supprimé ce patient</h1>
       </div>
       </div>
...
<!--################################################################################################################### -->
  <div class="home_content">
    <div class="text-center"><h1>Patient </h1></div>
   <!-- form -->
   <form  action="#" method="POST">
     <div class="container">
       <div class="row">
  ...
  ?>
    <tr>
      ...
      <button type="button" name="supp" class="btn btn-secondary supbtn" >supprimé</button></td>
    </tr>
    <?php
     }
    ?>
